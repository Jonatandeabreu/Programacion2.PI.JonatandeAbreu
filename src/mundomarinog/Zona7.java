 ...
 * @author Usuario
 */
public class Zona7 extends javax.swing.JFrame {

    /**
     * Creates new form Zona7
     */
    public Zona7() {
        initComponents();
        this.setLocationRelativeTo(this);
        this.setTitle("IMAGEN SHOW");
        String info = ("<html>IMAGEN SHOW<p><p>A través de un audiovisual proyectado en una pantalla de 18 metros de largo, conocerás el trabajo y esfuerzo diario de investigación, rescate, rehabilitación, re-inserción de fauna marina.<html>");
        Zonas zona7 = new Zonas(info);
        txtinfo.setText(zona7.toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes2/imagen show.png"))); // NOI18N
