 ...
 * @author Usuario
 */
public class Zona6 extends javax.swing.JFrame {

    /**
     * Creates new form Zona6
     */
    public Zona6() {
        initComponents();
         this.setLocationRelativeTo(this);
        this.setTitle("TEATRO SORPRESA");
        String info = ("<html>TEATRO SORPRESA<p><p>Una entretenida obra musical para que disfruten los más chiquitos de la familia.<html>");
        Zonas zona6 = new Zonas(info);
        txtinfo.setText(zona6.toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes2/Teatro.png"))); // NOI18N
